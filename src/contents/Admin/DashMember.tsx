...
const DashMember: React.FC = () => {
  ...
  const fetchAllUserList = (nickname: string, page: number) => {
    axios.post(`${process.env.REACT_APP_BACK_ADMIN_URL}/api/user/member`, {}, {
      params: {
        nickname: nickname,
        page: page
      },
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      ...
      <header style={{
        ...
        <h1 style={{ fontSize: 20, fontWeight: 700, color: TEXT_DARK, margin: 0 }}>회원 관리</h1>
